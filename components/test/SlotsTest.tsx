...
const testCourts: Court[] = [
  { 
    ...
    features: { color: '#8b5cf6', bgColor: 'bg-purple-100', textColor: 'text-purple-700' },
    priceMultiplier: 1.0,
    color: '#8b5cf6',
  ...
  { 
    ...
    operatingHours: { start: '00:00', end: '23:00', slot_duration: 90 },
    features: { color: '#ef4444', bgColor: 'bg-red-100', textColor: 'text-red-700' },
    priceMultiplier: 0.9,
    color: '#ef4444',
    bgColor: 'bg-red-100',
  ...
  { 
    ...
    operatingHours: { start: '00:00', end: '23:00', slot_duration: 90 },
    features: { color: '#22c55e', bgColor: 'bg-green-100', textColor: 'text-green-700' },
    priceMultiplier: 1.2,
    color: '#22c55e',
