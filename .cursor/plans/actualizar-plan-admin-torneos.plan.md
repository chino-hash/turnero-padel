---
name: Actualizar plan Admin Torneos
...
# Actualizar plan Completar sección Admin Torneos
...
- [admin-torneos-superadmin-inscripciones-2026-02.md](docs/actualizaciones/admin-torneos-superadmin-inscripciones-2026-02.md): el super admin **sí** puede crear torneos (seleccionando el club) y gestionar inscripciones en cualquier torneo con acceso.
...
**Del formulario** ([admin-torneos-formulario-2026-02.md](docs/actualizaciones/admin-torneos-formulario-2026-02.md)):
...
**De super admin e inscripciones** ([admin-torneos-superadmin-inscripciones-2026-02.md](docs/actualizaciones/admin-torneos-superadmin-inscripciones-2026-02.md)):
...
**De landing y menú** ([landing-login-menu-usuario-2026-02.md](docs/actualizaciones/landing-login-menu-usuario-2026-02.md)):
