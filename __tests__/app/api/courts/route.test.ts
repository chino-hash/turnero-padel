  ...
  const mockCourts = [
    {
      ...
      basePrice: 1000,
      priceMultiplier: 1.2,
      features: { color: 'from-green-400 to-green-600', bgColor: 'bg-green-100', textColor: 'text-green-700' },
    ...
    },
    {
      ...
      basePrice: 800,
      priceMultiplier: 1.0,
      features: { color: 'from-blue-400 to-blue-600', bgColor: 'bg-blue-100', textColor: 'text-blue-700' },
      operatingHours: { start: '08:00', end: '23:00', slot_duration: 90 },
